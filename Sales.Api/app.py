...
def handle_exception(e):
    ...
    if isinstance(e, DownstreamServiceError):
        status = e.status_code
        title = "Servicio no disponible" if status == 503 else "Error de integracion"
        detail = str(e)
    elif isinstance(e, KeyError) or isinstance(e, FileNotFoundError) or "not found" in e_str:
        status = 404
...
def swagger_ui():
    ...
    <head>
      <meta charset="UTF-8">
      <title>Documentación de la API de Ventas - Swagger UI</title>
